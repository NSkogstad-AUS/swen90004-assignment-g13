...
All commands must be run from inside the `hotelling-law/` directory:
...
python3 experiments/replication_sweep.py
python3 experiments/extension_loyalty.py
```
...
Or directly with unittest discovery (also from inside `hotelling-law/`):
